...
namespace Sculptor.Gynac.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public GynacEntities _newContext;

        public AccountController()
        {
            context = new ApplicationDbContext();
            _newContext = new GynacEntities();
        }
        ...
        {
            ViewBag.adminUserId = User.Identity.GetUserId();                    
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    facultymodel.AspNetUsersId = user.Id;
                    facultymodel.Name = model.FirstName;
                    _newContext.Faculties.Add(facultymodel);
        ...
        [AllowAnonymous]
        public ActionResult ResetPassword(string code = "gynac")
        {
